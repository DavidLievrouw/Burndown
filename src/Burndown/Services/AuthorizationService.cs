...
public class AuthorizationService {
    ...
    public Uri GetSignInUrl(string? state) {
        ...
        return new Uri(
            $"{fireflySettings.AuthorizationEndpoint.AbsoluteUri.TrimEnd('/')}?response_type=code&client_id={fireflySettings.ClientId}&redirect_uri={fireflySettings.RedirectUri}&scope=&state={state ?? string.Empty}",
            UriKind.Absolute
        );
    }
